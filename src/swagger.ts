...
const document = {
  info: {
    ...
    version: "2.0",
    // by default: 'REST API'
    title: "Autobiography API",
    // by default: ''
    description: "Autobiography API documentation from Swagger",
  },
  ...
  definitions: {
    ...
    IssueDecision: {
      ...
      $outcome: {
        required: true,
        "@enum":
          /** @type {import('@pins/api').Schema.InspectorDecisionOutcomeType} */ [
            "allowed",
            "dismissed",
            "split decision",
          ],
